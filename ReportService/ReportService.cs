...
namespace ReportService
{
    public partial class ReportService : ServiceBase
    {
        ...
        private ErrorRepositories _errorRepository = new ErrorRepositories();
        private ReportRepository _reportRepository = new ReportRepository();
        private Email _email;
        private GenerateHtmlEmail _htmlEmail = new GenerateHtmlEmail();
        private string _emailReceiver;
        private StringCipher _stringCipher = new StringCipher("6A7722F1-4209-40C5-88ED-B1D7028D3C47");
        private string _passwordPrefix = "encrypt:";
        private readonly bool _reportsShouldBeSend;
        ...
        public ReportService()
        {
            ...
            try
            {
                ...
                _reportsShouldBeSend = Convert.ToBoolean(ConfigurationManager.AppSettings["ReportsShouldBeSend"]);
        ...
        private string DecryptSenderEmailPassword()
        {
            ...
            if (encryptedPassword.StartsWith(_passwordPrefix))
            {
                encryptedPassword = _stringCipher
                    .Encrypt(encryptedPassword.Replace(_passwordPrefix, ""));
        ...
        private async Task SendReport()
        {
            ...
            await _email.Send("Raport sprzedaży",
                _htmlEmail.GenerateReport(report), _emailReceiver);
        ...
        private async Task SendError()
        {
            ...
            await _email.Send("Błędy w apce",
                _htmlEmail.GenerateErrors(errors, _intervalInMinutes), _emailReceiver);
